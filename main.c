...
int main() {
    notsimd("parrots_512x256.raw\0", 512, 256, 3); // 3 is for the kernel size, can be 5 or 7 too
    issimd("parrots_512x256.raw\0", 512, 256, 3); // 3 is for the kernel size, can be 5 or 7 too
